    ...
    <div className={styles.rootCont} id="contact">
      ...
      <Form onSubmit={handleOnSubmit}>
        ...
        <div className={styles.iconsCont}>
          ...
          <a
            href="https://www.linkedin.com/in/dipak-tange-279b05126"
            target="_blank"
            rel="noreferrer"
          >
            <AiFillLinkedin className={styles.linkedInIcon} />
          </a>
          <a href="https://github.com/deep1296" rel="noreferrer" target="_blank">
            <AiOutlineGithub className={styles.gitIcon} />
          </a>
        </div>
        <p className={styles.text}>Phone: 8600011801</p>{" "}
        <p className={styles.text}>Email: deeptange@gmail.com</p>
      </Fade>
    </div>
  )
}
