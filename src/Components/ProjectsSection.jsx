...
const projects = [
  {
    ...
    about:
      "“An e-commerce website of fitness apparel and accessories. Implemented features to get data from backend.",
    stacks: [
  ...
  },
  {
    ...
    about:
      "An e-commerce website of beauty products and therapy. Created in 5 days using HTML,CSS,JavaScript",
    stacks: [
      <SiJavascript className={styles.stackIcon} />,
      <SiHtml5 className={styles.stackIcon} />,
      <SiCss3 className={styles.stackIcon} />,
